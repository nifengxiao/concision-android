...
import com.creator.concision.network.ExceptionHandle
import com.creator.concision.network.ResultState
import com.creator.concision.network.paresException
import com.creator.concision.network.paresResult
 ...
 *
 */
fun <T> CommonBaseActivity<*,*>.parseState(
 ...
 *
 */
fun <T> CommonBaseFragment<*,*>.parseState(
    resultState: ResultState<T>,
    onSuccess: (T) -> Unit,
    onError: ((AppException) -> Unit)? = null,
    onLoading: (() -> Unit)? = null
